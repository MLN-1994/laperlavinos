...
export function normalizePublicityConfig(input: PublicityConfigInput | null | undefined): PublicityConfig {
  return {
    ...
    promo_cta_label: input?.promo_cta_label !== undefined && input?.promo_cta_label !== null ? input.promo_cta_label.trim() : defaultPublicityConfig.promo_cta_label,
    promo_cta_href: input?.promo_cta_href !== undefined && input?.promo_cta_href !== null ? input.promo_cta_href.trim() : defaultPublicityConfig.promo_cta_href,
