...
export default function Header() {
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-neutral-800/60 bg-neutral-900/90 backdrop-blur-md transition-all">
        <div className="container mx-auto flex h-16 items-center justify-between px-6">
          ...
          <nav className="hidden md:flex gap-8 text-xs font-bold uppercase tracking-[0.2em]">
            ...
            <Link href="/productos" className="text-neutral-300 hover:text-white transition-colors">
              Productos
            </Link>
          </nav>
