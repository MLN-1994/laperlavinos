...
const AdminSearchBar: React.FC<AdminSearchBarProps> = ({ value, onChange }) => {
	return (
		<div className="space-y-1.5">
			...
			<input
				type="text"
				className="w-full rounded-sm border border-neutral-200 bg-neutral-50 px-3 py-2.5 pl-10 text-sm text-neutral-800 outline-none transition focus:border-[#a68a5c]"
